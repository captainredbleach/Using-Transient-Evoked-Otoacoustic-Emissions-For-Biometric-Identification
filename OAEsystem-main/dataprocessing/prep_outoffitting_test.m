mat_files = dir("/home/lab-user/datasets/project_data/out_of_fitting_data/*mat");
target_test_path = "/home/lab-user/datasets/project_data/out_of_fitting_data/Test";
Fs=48000;
for cur_file = 1:length(mat_files)
    path = mat_files(cur_file).name;
    fullpath = sprintf("/home/lab-user/datasets/project_data/out_of_fitting_data/%s", path)
